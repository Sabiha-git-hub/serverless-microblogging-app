...
export class AppStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Register function needs SignUp permission (not Admin permissions)
    ...
    this.postsTable.grantReadData(createCommentFunction);
    ...
    // Comment endpoints
    const commentsResource = postId.addResource('comments');
    commentsResource.addMethod('GET', new apigateway.LambdaIntegration(getCommentsFunction));
    commentsResource.addMethod('POST', new apigateway.LambdaIntegration(createCommentFunction));
