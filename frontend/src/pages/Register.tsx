...
const Register: React.FC = () => {
  ...
  // Password validation requirements (Cognito default policy)
  ...
  return (
    <div className="register-container">
      ...
      <form onSubmit={handleSubmit}>
          ...
          {password && (
            <div className="password-requirements">
              ...
              <div className={`requirement ${passwordRequirements.hasSpecialChar ? 'met' : ''}`}>
                <span className="checkmark">{passwordRequirements.hasSpecialChar ? '✓' : '○'}</span>
          ...
          {confirmPassword && (
            <div className="password-requirements">
              <div className={`requirement ${passwordsMatch ? 'met' : ''}`}>
                <span className="checkmark">{passwordsMatch ? '✓' : '○'}</span>
                Passwords match
              </div>
            </div>
          )}
        ...
        <button
          type="submit"
          disabled={loading || !allRequirementsMet || !passwordsMatch || !username || !email || !displayName}
        >
